...
<div class="ui container" style="margin-top: 2em;">
    ...
    <?php if ( have_posts() ) : ?>
        ...
        <header class="ui header">
            <h1 class="ui header">
                <?php printf( esc_html__( 'Search Results for: %s', 'programmerbee.com' ), '<span>' . get_search_query() . '</span>' ); ?>
            </h1>
        </header>
    ...
    <?php else : ?>
        ...
        <header class="ui header">
            <h1 class="ui header"><?php esc_html_e( 'Nothing Found', 'programmerbee.com' ); ?></h1>
        </header>
